...
void LidarSlamNode::SetSlamParameters()
{
  ...
  SetSlamParam(int,    "slam/localization/blob_distance_nbr_neighbors", LocalizationBlobDistanceNbrNeighbors)
  ...
  SetSlamParam(double, "slam/localization/blob_distance_factor", LocalizationBlobDistancefactor)
  ...
  SetSlamParam(double, "slam/localization/max_blob_distance", LocalizationMaxBlobDistance)
