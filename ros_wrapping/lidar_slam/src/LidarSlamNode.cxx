...
void LidarSlamNode::SetSlamParameters()
{
  ...
  {
    if (interpolationModel > LidarSlam::Interpolation::Model::CUBIC_SPLINE)
    {
    ...
    LidarSlam.SetInterpoModel(static_cast<LidarSlam::Interpolation::Model>(interpolationModel));
  }
